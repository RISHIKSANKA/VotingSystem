    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item"><a class="nav-link" href="voter-home">Home</a>
                </li>
...
<div class="limiter" style="margin-top: 70px!important;">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="edit-voter-profile" method="post">
                <div class="wrap-input100 validate-input m-b-26"
                    ...
                    <span class="label-input100">First Name</span> <input
                        ...
                        placeholder="Enter firstname" value="${voter.name}"> <span
                ...
                <div class="wrap-input100 validate-input m-b-26"
                    ...
                    <span class="label-input100">Surname</span> <input
                        ...
                        placeholder="Enter surname" value="${voter.surname}"> <span class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input m-b-26"
                ...
                <div class="wrap-input100 validate-input m-b-26"
                    ...
                    <span class="label-input100">EMAILID</span> <input
                        ...
                        placeholder="Enter EMAILID" value="${voter.emailId}"
                ...
                <div class="wrap-input100 validate-input m-b-26"
                    ...
                    <span class="label-input100">Mobile Number</span> <input
                        ...
                        placeholder="Enter Mobile Number" value="${voter.mobileNum}"> <span
                        class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input m-b-26"
                    ...
                    <span class="label-input100">LOGIN ID</span> <input
                        ...
                        placeholder="Enter Login Id" value="${voter.loginId}" disabled="disabled"> <span
                        class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input m-b-26"
                     data-validate="DL Number is required">
                    <span class="label-input100">VOTER ID</span> <input
                        class="input100" type="text" name="dLNum"
                        placeholder="Enter Voter Id" value="${voter.dLNum}"> <span
                        class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input m-b-18"
                    ...
                    <span class="label-input100">Password</span> <input
                        ...
                        placeholder="Enter password" value="${voter.password}"> <span
                        class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input m-b-18"
                     data-validate="Password is required">
                    <span class="label-input100">Confirm Password</span> <input
                        ...
                        placeholder="Confirm password" value="${voter.password}"> <span
                        class="focus-input100"></span>
                </div>
                ...
                <div class="wrap-input100 validate-input m-b-26"
                    ...
                    <span class="label-input100">Hint Answer</span> <input
                        ...
                        placeholder="Enter Hint Question" value="${voter.hintQuestion}"> <span
                        class="focus-input100"></span>
                </div>
                ...
                <div class="wrap-input100 validate-input m-b-26"
                    ...
                    <span class="label-input100">Hint Answer</span> <input
                        ...
                        placeholder="Enter Hint Answer" value="${voter.hintAnswer}"> <span
                        class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input m-b-26">

            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
                        <a class="dropdown-item" href="edit-voter-profile">Edit</a>
    ...
    <div class="row">
        ...
        <div class="col-4 md-3 ">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <center>
                        <a href="cast-vote" class="btn btn-primary">VOTE NOW!</a>
                        <a href="view-cast-vote" class="btn btn-primary">VIEW VOTE</a>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-4  md-3">
            <div class="card h-100">
                ...
                <div class="card-footer">
                    <center>
                        <a href="voter-view-result" class="btn btn-primary">HIT ME!</a>
                    </center>
                </div>
            </div>
        </div>
